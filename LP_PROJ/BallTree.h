...
public:
	...
	BallTree(std::vector<Coordinate> coordenades) { construirArbre(coordenades);}
	...
	void construirArbre(std::vector<Coordinate> coordenades);
	...
	Coordinate calculaPuntLlunya(const std::vector<Coordinate>& coordenades, const Coordinate& ref);
	BallTree* construirArbreRecursiu(std::vector<Coordinate> recorregutCoordenades);
	void dretaOEsquerra(std::vector<Coordinate>& partEsquerra, std::vector<Coordinate>& partDreta, const std::vector<Coordinate>& coordenades, const Coordinate& puntA, const Coordinate& puntB);
